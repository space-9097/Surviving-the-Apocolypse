...
var foodwaterSound, gameoverSound, monsterSound, peopleSound, fuelSound, milestoneSound, backgroundMusic
var muteButton
...
function preload() {
  ...
  foodwaterSound = loadSound('Food+watersound.wav')
  gameoverSound = loadSound('GameoverSound.wav')
  monsterSound = loadSound('MonsterSound.wav')
  fuelSound = loadSound('FuelSound.wav')
  peopleSound = loadSound('PeopleSound.wav')
  milestoneSound = loadSound('100milestone.wav')
  backgroundMusic = loadSound('backgroundMusci.wav')
}
...
function setup() {
  ...
  //mute button
  muteButton = createImg('MuteButton.gif')
  muteButton.position(725, 35)
...
function draw() {
  ...
  if (gamestate === PLAY) {
    ...
    //distance travelled
    distanceTravelled += Math.round(getFrameRate() / 60)
    //every 100 sound
  ...
  text("Distance Travelled:" + distanceTravelled, 80, 125)
}
